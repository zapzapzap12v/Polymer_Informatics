...
export interface StaggeredMenuItemReal {
  label: string;
  ariaLabel: string;
  link: string;
}
export interface StaggeredMenuSocialItemReal {
  label: string;
  link: string;
}
export interface StaggeredMenuPropsReal {
  position?: 'left' | 'right';
  colors?: string[];
  items?: StaggeredMenuItemReal[];
  socialItems?: StaggeredMenuSocialItemReal[];
...
export const StaggeredMenuReal: React.FC<StaggeredMenuPropsReal> = ({
  position = 'right',
